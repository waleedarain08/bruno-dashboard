                ...
                <Paper sx={{ width: '100%', mb: 2 }}>
                    ...
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow style={{}}>
                                    <TableCell style={{}} align="center">Ingredient Ref.</TableCell>
                                    <TableCell style={{}} align="center">Ingredient Name</TableCell>
                                    <TableCell style={{}} align="center">Total Order Amount per ingredient (in GRAMS)</TableCell>
                                    <TableCell style={{ color: "#fff", backgroundColor: "#D78809" }} align="center">Order Ref 111</TableCell>
                                    <TableCell style={{ color: "#fff", backgroundColor: "#D78809" }} align="center">Order Ref 112</TableCell>
                                    <TableCell style={{ color: "#fff", backgroundColor: "#D78809" }} align="center">Order Ref 113</TableCell>
                                    <TableCell style={{ color: "#fff", backgroundColor: "#D78809" }} align="center">Order Ref 114</TableCell>
                                    <TableCell style={{ color: "#fff", backgroundColor: "#D78809" }} align="center">Order Ref 115</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
