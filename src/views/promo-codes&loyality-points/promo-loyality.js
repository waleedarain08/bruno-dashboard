              ...
              <CardContent>
                <Grid container direction="column" justifyContent="center" spacing={2}>
                  ...
                  >
                    {({ errors, handleBlur, handleChange, handleSubmit, touched, values }) => (
                      <form noValidate onSubmit={handleSubmit} {...others}>
                        <FormControl fullWidth error={Boolean(touched.VAT && errors.VAT)} sx={{ ...theme.typography.customInput }}>
              ...
              >
                {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                  <form noValidate onSubmit={handleSubmit} {...others}>
                    ...
                    <FormControl fullWidth error={Boolean(touched.type && errors.type)} sx={{ ...theme.typography.customInput, mt: 2 }}>
                      ...
                      <Select
                        ...
                        onBlur={handleBlur}
                      >
                        <MenuItem value="fixed">AED (Fixed)</MenuItem>
                    ...
                    <FormControl
                      ...
                      sx={{ ...theme.typography.customInput }}
                    >
                      <InputLabel htmlFor="outlined-adornment-password-login">Enter AED or % of discount in int format</InputLabel>
                      <OutlinedInput
              ...
              <TableBody>
                {rows.map((row) => (
                  <TableRow key={row?.name} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    ...
                    <TableCell align="center">{row?.type === 'percentage' ? `${row?.discount}%` : `${row?.discount} AED`}</TableCell>
