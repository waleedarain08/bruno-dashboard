            ...
            <Box sx={{
              ...
              <AnimateButton>
                <Button
                  ...
                  onClick={() => onDelete()}
                >
                  {delLoading ? <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', marginRight: 30 }}>
                    <InfinitySpin width="50" height="20" color="#fff" />
                  </div> : "Delete"}
                </Button>
              </AnimateButton>
                  ...
                  {typeforView !== "FAQ" && <TableCell align="center">
                    {row?.media?.length > 0 ?
                      <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <AvatarGroup max={2}>
                          {row?.media?.map((i, index) => <Avatar key={index} alt="Remy Sharp" src={i} />)}
                        </AvatarGroup>
                      </div>
                      :
                      <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
